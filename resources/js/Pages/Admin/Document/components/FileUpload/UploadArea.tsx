...
const UploadArea: React.FC<UploadAreaProps> = ({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-500 mb-6 font-medium">OR</p>
      
      <button
        onClick={onBrowseFiles}
        className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-lg text-sm font-bold tracking-wide transition-colors"
      >
        BROWSE FILES
      </button>
    </div>
