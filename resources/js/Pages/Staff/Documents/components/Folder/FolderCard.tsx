...
const FolderCard: React.FC<FolderCardProps> = ({
  ...
  return (
    <div className="relative group">
      ...
      <div
        className={`relative bg-gradient-to-br from-[#228B22] to-[#1a6b1a] rounded-2xl p-6 border border-white/10 hover:border-white/20 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 ${
